...
class ReportPurchaseJournalDetail(models.Model):
    _name = 'report.purchase.journal.detail.goods'
    _auto = False 
    ...
    def reload_data(self,*kw):
        ...
        if 'vi_VN' in self._context.values():
            name = 'Sổ chi tiết mua hàng theo sản phẩm'
        else:
            name = 'Purchase Journal Detail By Goods'
 
        return { 
            'name': name,
            "type": "ir.actions.act_window",
            "view_mode": "tree",
            "res_model": 'report.purchase.journal.detail.goods' ,
