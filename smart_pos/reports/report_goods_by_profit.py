...
class ReportGoodsByProfit(models.Model):
    _name = 'report.goods.by.profit'
    _auto = False
    id = fields.Integer(string='ID')
    goods_code = fields.Char(string='Code')
    ...
    total_cost_price=fields.Float(string='Total cost price')
    ...
    def reload_data(self,*kw):
        ...
        return { 
            ...
            "view_mode": "tree",
            "res_model": 'report.goods.by.profit' ,
