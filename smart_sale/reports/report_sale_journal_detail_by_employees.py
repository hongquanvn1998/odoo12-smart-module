...
class ReportSaleJournalDetailEmployee(models.Model):
    _name = 'report.sale.journal.detail.employees'
    _auto = False 
    ...
    def reload_data(self,*kw):
        ...
        if 'vi_VN' in self._context.values():
            name = 'Sổ chi tiết bán hàng theo nhân viên'
        else:
            name = 'Sale Journal Detail By Employees'

        return { 
            # 'name': _('Sale Journal Detail By Employees'),
            'name':name,
            "type": "ir.actions.act_window",
            "view_mode": "tree",
            "res_model": 'report.sale.journal.detail.employees' ,
