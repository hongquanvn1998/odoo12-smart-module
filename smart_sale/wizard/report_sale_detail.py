...
class ReportSaleDetail(models.TransientModel):
    ...
    def set_params_to_list(self):  
        ...
        if self.report_type == 0:
            ...
            return self.env.get('report.sale.journal.detail.goods').reload_data(params)
        ...
        if self.report_type == 1:
            ...
            return self.env.get('report.sale.journal.detail.customers').reload_data(params)
        ...
        if self.report_type == 2:
            ...
            return self.env.get('report.sale.journal.detail.employees').reload_data(params)

  

class GetJournalDetailView(models.AbstractModel):
    _name='report.smart_sale.reportjournaldetail_display'
